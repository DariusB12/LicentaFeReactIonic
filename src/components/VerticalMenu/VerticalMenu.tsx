    ...
    return (
        <>
            <div className={`vertical-menu-container roboto-style ${isMobileMenuOpen ? 'open' : ''}`}>
                <div className="vertical-menu-top-container">
                    <div className="vertical-menu-top-container-top kaushan-script-style">
                        SocialMind <button className="vertical-menu-info-button"><img src="/icons/info.png"
                                                                                      alt="info_img"
                ...
                <div className="vertical-menu-container-bottom-conatiner">
                    <div className="vertical-menu-container-bottom-buttons">
                        ...
                        <button className="vertical-menu-container-view-button black-button">View All Accounts</button>
                    </div>
                    <div className="vertical-menu-container-bottom">
                        <button className="vertical-menu-container-logout-button">- Logout -</button>
                        <button className="vertical-menu-container-delete-account-button">- Delete Account -</button>
                    </div>
                </div>

            </div>
            <div className={`vertical-menu-container-grey-background-for-hamburger-menu ${isMobileMenuOpen ? 'open' : ''}`}
            ...
            <div className="vertical-menu-hamburger-container">
                ...
                <button className="vertical-menu-hamburger-view-button black-button"><img src="/icons/view_icon.png"
                                                                                          alt="view_img"
                ...
                <button className="vertical-menu-hamburger-info-button"><img src="/icons/info.png"
                                                                   alt="info_img"
