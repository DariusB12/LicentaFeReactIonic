                ...
                <div className="edit-profile-popup-middle-content">
                    ...
                    <div className="edit-profile-popup-profile-details-container">
                        ...
                        <div className="edit-profile-posts-container roboto-style">
                            ...
                            posts
                            {noOfPostsError && <div className="edit-popup-profile-error-messaage">{noOfPostsErrorMessage}</div>}
                        </div>
                        <div className="edit-profile-followers-container roboto-style">
                            ...
                            followers
                            {noOfFollowersError && <div className="edit-popup-profile-error-messaage">{noOfFollowersErrorMessage}</div>}
                        ...
                        <div className="edit-profile-following-container">
                            ...
                            following
                            {noOfFollowingError && <div className="edit-popup-profile-error-messaage">{noOfFollowingErrorMessage}</div>}
                        ...
                        <div className="edit-profile-username-container">
                            ...
                            {usernameError && <div className="edit-popup-profile-error-messaage">{usernameErrorMessage}</div>}
                        </div>
                    </div>
                </div>
